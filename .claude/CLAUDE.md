...
<!-- USER-ADDED: squads-system -->
## 📦 AIOX Squads — Agentes Especializados

### O que é um Squad?

Um squad é um **pacote self-contained de agentes IA especializados** em um domínio específico (branding, pesquisa, frontend, legal, etc.). Cada squad tem sua própria cadeia de comando (Chief → Masters → Specialists).

### ✅ Squads Instalados (12 total)

| Squad | Comando | Status | Domínio |
|-------|---------|--------|---------|
| **Apex** | `/apex-chief` | 🟢 OPERATIONAL | Frontend Ultra-Premium |
| **Brand** | `/brand-chief` | 🟡 DEVELOPING | Branding Elite |
| **Curator** | `/curator-chief` | 🟡 DEVELOPING | Curadoria de Conteúdo |
| **Deep Research** | `/deep-research-chief` | 🟢 OPERATIONAL | Pesquisa Profunda |
| **Dispatch** | `/dispatch-chief` | 🟡 DEVELOPING | Execução Paralela |
| **Education** | `/education-chief` | 🟡 DEVELOPING | Aprendizado |
| **Kaizen** | `/kaizen-chief` | 🟡 DEVELOPING | Melhoria Contínua |
| **Kaizen V2** | `/kaizen-v2-chief` | 🟢 OPERATIONAL | Sistema Nervoso |
| **Legal Analyst** | `/legal-analyst-chief` | 🟢 OPERATIONAL | Análise Jurídica |
| **SEO** | `/seo-chief` | 🟡 DEVELOPING | Otimização SEO |
| **Squad Creator** | `/squad-creator-chief` | 🟢 OPERATIONAL | Fábrica de Squads (Free) |
| **Squad Creator Pro** | `/squad-creator-pro-chief` | 🟢 OPERATIONAL | Fábrica de Squads (Premium) |
...
**Opção 3: Comando AIOX**
```
*activate-squad brand
*activate-squad deep-research
*activate-squad squad-creator-pro
```

### 📖 Documentação

- **`SQUADS-REGISTRO.md`** — Catálogo completo com descrições detalhadas
- **`SQUADS-QUICK-START.md`** — Guia de Quick Start com exemplos práticos
- **`.claude/squads-skills.json`** — Mapeamento técnico de slash commands
- **`squads/{nome}/README.md`** — Documentação de cada squad

### 💡 Dicas

- **Composição**: Misture squads livremente no mesmo projeto
- **Handoff**: Os agentes fazem handoff entre si automaticamente
- **Reuse**: Cada squad é self-contained — pegue o que precisa

<!-- USER-ADDED-END: squads-system -->
